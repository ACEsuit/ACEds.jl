...
using ACEds.MatrixModels: NewMatrixModel, new_matrixmodel
...
rcut = 8.0
acnc = :nc
m_inv = new_matrixmodel(ACE.Invariant(),species_friction,species_env, acnc; n_rep = 2, rcut_on = rcut, rcut_off = rcut, maxorder_on=2, maxdeg_on=5,

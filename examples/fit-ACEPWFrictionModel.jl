...
using Flux.MLUtils
using ACE
using ACEds: new_ac_matrixmodel, new_pw_matrixmodel
using Random
...
m_inv = new_pw_matrixmodel(ACE.Invariant(),species_friction,species_env; n_rep = 2, maxorder_off=2, maxdeg_off=5,
        species_maxorder_dict_off = Dict( :H => 0), 
        species_weight_cat_off = Dict(:H => 1.0, :Cu=> 1.0),
        bond_weight = .5
    );
m_cov = new_ac_matrixmodel(ACE.EuclideanVector(Float64),species_friction,species_env; n_rep = 2, maxorder_off=2, maxdeg_off=5,
        species_maxorder_dict_off = Dict( :H => 0), 
        species_weight_cat_off = Dict(:H => 1.0, :Cu=> 1.0),
        bond_weight = .5
    );

m_equ = new_ac_matrixmodel(ACE.EuclideanMatrix(Float64),species_friction,species_env; n_rep = 2, maxorder_off=2, maxdeg_off=5,
        species_maxorder_dict_off = Dict( :H => 0), 
        species_weight_cat_off = Dict(:H => 1.0, :Cu=> 1.0),
        bond_weight = .5
    );

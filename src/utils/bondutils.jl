...
import ACEbonds: EllipsoidBondBasis, SymmetricEllipsoidBondBasis

const DSphereBasis = EllipsoidBondBasis # this alias allows to use constructors for EllipsoidBondBasis in ACEbonds to create suitable basis selectors
const SymmetricDSphereBondBasis = SymmetricEllipsoidBondBasis
